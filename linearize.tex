...
The neural network is expected to learn the following relationships:
\begin{align}
...
The sample code contains logic to calculate these expressions for the $2^2$ cases arising from the
two nonlinear PReLUs. See figure \ref{output} for the expressions derived from this model.
