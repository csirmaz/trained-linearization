...
most significatn input, tools that allow experimenting with the input data
...
extracted from it, which then can be reviewed or even used by human decision-makers.
